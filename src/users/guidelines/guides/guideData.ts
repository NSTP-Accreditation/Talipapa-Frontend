import { FileText, IdCard, Building2, Home, Droplets, Shield, Activity, MapPin, Car, AlertCircle , File} from 'lucide-react';
...
export const guidesData: Record<string, GuideData> = {
  ...
  'barangay-affidavit': {
    ...
    description: 'A barangay affidavit is a sworn statement or declaration used for various legal purposes within the barangay jurisdiction.',
    icon: FileText,
    ...
    steps: [
      {
        ...
        description: "Prepare all details and facts that need to be included in the affidavit.",
        notes: "Be clear about the purpose and ensure all information is accurate and truthful."
      },
      {
        id: 2,
        title: "Visit Barangay Office",
        description: "Go to the barangay office and request for an affidavit form.",
      ...
      },
      {
        ...
        description: "Work with barangay staff to draft the affidavit with accurate details.",
        notes: "Review carefully before proceeding to oath-taking."
      },
      {
        id: 4,
        title: "Take Oath",
        description: "Take an oath before the barangay official or notary public.",
  ...
  'business-clearance': {
    ...
    description: 'A business clearance from the barangay is required before you can operate any business within the barangay jurisdiction.',
    icon: Building2,
    ...
    steps: [
      {
        ...
        description: "Gather all necessary documents for your business registration.",
        requirements: [
        ...
        notes: "Ensure your business location is within the barangay jurisdiction."
      },
      {
        id: 2,
        title: "Visit Barangay Office",
        description: "Go to the barangay office and submit your application for business clearance.",
        notes: "Some barangays require inspection of the business premises."
      },
      {
        id: 3,
        title: "Pay Barangay Business Tax",
        description: "Pay the required barangay business tax and clearance fee.",
        requirements: ["Business tax (varies by business type)", "Clearance fee: ₱100-₱500"],
        notes: "Fees depend on the nature and size of your business."
      },
      {
        id: 4,
        title: "Inspection (if required)",
        description: "Allow barangay officials to inspect your business premises if required.",
        notes: "Ensure your business complies with health, safety, and zoning regulations."
      },
      {
        id: 5,
        title: "Claim Business Clearance",
        description: "Return to claim your barangay business clearance once approved.",
  ...
  'certificate-of-indigency': {
    ...
    description: 'A certificate that attests to the financial status of an individual or family, often required for medical assistance, scholarships, or legal purposes.',
    icon: File,
    ...
    steps: [
      ...
      },
      {
        id: 2,
        title: "Visit Barangay Office",
        description: "Go to the barangay office and request a Certificate of Indigency.",
        notes: "Be prepared to explain the purpose of the certificate."
      },
      {
        id: 3,
        title: "Fill Out Application",
        description: "Complete the application form with accurate information about your financial situation.",
        notes: "Barangay officials may conduct a home visit to verify your circumstances."
      },
      {
        id: 4,
        title: "Home Visit Verification",
        description: "Cooperate with barangay officials if they conduct a home visit for verification.",
        notes: "This step ensures the certificate is issued to those who genuinely need it."
      },
      {
        id: 5,
        title: "Pay Minimal Fee",
        description: "Pay the minimal processing fee if required.",
        requirements: ["Processing fee: ₱20-₱50 (or free for indigent residents)"],
  ...
  'certificate-of-residency': {
    ...
    description: 'A document that certifies you are a resident of the barangay, often required for various transactions and applications.',
    icon: Home,
    ...
    steps: [
      {
        ...
        description: "Gather documents that prove your residency in the barangay.",
        requirements: [
          "Valid ID",
      ...
      },
      {
        id: 2,
        title: "Visit Barangay Office",
        description: "Go to the barangay office and request for Certificate of Residency.",
        notes: "Office hours are Monday to Friday, 8:00 AM to 5:00 PM."
      },
      {
        id: 3,
        title: "Fill Out Application Form",
        description: "Complete the application form with your personal information and purpose.",
        requirements: [
  ...
  'flood-assistance': {
    ...
    description: 'Guidelines for requesting emergency assistance and relief during and after flooding incidents in the barangay.',
    icon: Droplets,
    ...
    steps: [
      {
        ...
        description: "Immediately report to the barangay office or emergency hotline during flooding.",
      ...
      },
      {
        ...
        notes: "Bring important documents and emergency supplies to evacuation centers."
      },
      {
        id: 3,
        title: "Document Damages",
        description: "Take photos and document all flood damages to your property.",
        requirements: [
          "Photos of damages",
      ...
      },
      {
        ...
        description: "Submit application for flood assistance at the barangay office.",
        requirements: [
          "Valid ID",
          "Proof of residency",
        ...
        notes: "Applications are processed on a first-come, first-served basis."
      },
      {
        id: 5,
        title: "Receive Relief Goods",
        description: "Claim relief goods and assistance as allocated by the barangay.",
        notes: "Additional assistance may be available from the city or national government."
      }
    ],
    requirements: [
  ...
  'good-moral-character': {
    ...
    description: 'A certificate attesting to your good moral standing in the community, often required for employment, school, or visa applications.',
    icon: Shield,
    estimatedTime: '1-3 business days',
    difficulty: 'Easy',
    steps: [
      ...
      },
      {
        id: 2,
        title: "Visit Barangay Office",
        description: "Go to the barangay office and request for Certificate of Good Moral Character.",
      ...
      },
      {
        ...
        description: "Barangay officials will verify your records and moral standing in the community.",
        notes: "This may involve checking with barangay tanods and officials."
      },
      {
        id: 5,
        title: "Pay Fee and Claim",
        description: "Pay the processing fee and claim your certificate once approved.",
        requirements: ["Processing fee: ₱50-₱100"],
  ...
  'health-certificate': {
    ...
    description: 'A health certificate issued for various purposes including employment, food handling, or travel requirements.',
    icon: Activity,
    ...
    steps: [
      {
        ...
        notes: "Health center hours are usually Monday to Friday, 8:00 AM to 5:00 PM."
      },
      {
        id: 2,
        title: "Medical Examination",
        description: "Undergo basic medical examination by the barangay health worker or nurse.",
      ...
      },
      {
        id: 5,
        title: "Claim Certificate",
        description: "Return to claim your health certificate once results are ready.",
        requirements: ["Official receipt", "Valid ID"],
  ...
  'land-use-permit': {
    ...
    description: 'A permit required for construction or land development within the barangay, ensuring compliance with zoning regulations.',
    icon: MapPin,
    ...
    steps: [
      {
        ...
        description: "Gather all documents related to your property and proposed development.",
        requirements: [
      ...
      },
      {
        ...
        description: "Submit your application for land use permit at the barangay office.",
      ...
      },
      {
        ...
        notes: "This permit must be obtained before applying for a building permit."
      }
    ],
    requirements: [
      "Land title or Tax Declaration",
    ...
    steps: [
      {
        ...
        notes: "PhilSys registration is handled by PSA. The barangay may assist with scheduling or information."
      },
      {
        id: 2,
        title: "Check Registration Schedule",
        description: "Inquire at the barangay office about PhilSys registration schedules.",
        notes: "Some barangays coordinate with PSA for mass registration drives."
      },
      {
        id: 3,
        title: "Pre-register Online (Optional)",
        description: "You can pre-register online through the official PhilSys website.",
        notes: "Pre-registration helps speed up the process at the registration center."
      },
      {
        id: 4,
        title: "Visit Registration Center",
        description: "Go to the designated PSA registration center or mobile registration unit.",
        requirements: [
          "Original documents",
      ...
      },
      {
        ...
        description: "Wait for your PhilSys ID to be delivered to your registered address.",
        notes: "Processing may take several months. You'll receive an ePhilID via email first."
      }
    ],
    requirements: [
  ...
  'quezon-city-id': {
    ...
    description: 'The official identification card for Quezon City residents, which can be obtained through your barangay.',
    icon: IdCard,
    ...
    steps: [
      ...
      },
      {
        id: 3,
        title: "Fill Out Application Form",
        description: "Complete the QC ID application form with accurate information.",
        requirements: [
          "Personal information",
          "Contact details",
      ...
      },
      {
        ...
        description: "Return to claim your QC ID once notified that it's ready.",
  ...
  'restricted-area-pass': {
    ...
    description: 'A pass required for entering or working in restricted or controlled areas within the barangay, especially during emergencies or special circumstances.',
    icon: AlertCircle,
    estimatedTime: '1-2 days',
    difficulty: 'Easy',
    steps: [
      {
        ...
        notes: "Common purposes include: work, medical, emergency, essential services."
      },
      {
        id: 2,
        title: "Prepare Documents",
      ...
      },
      {
        id: 3,
        title: "Visit Barangay Office",
        description: "Go to the barangay office to apply for the restricted area pass.",
        notes: "During emergencies, special processing windows may be set up."
      },
      {
        id: 4,
        title: "Fill Out Application",
        description: "Complete the application form with details about your need for the pass.",
        requirements: [
          "Personal information",
      ...
      },
      {
        ...
        description: "Submit your application and receive your pass if approved.",
  ...
  'traffic-clearance': {
    ...
    description: 'A clearance required for events or activities that may affect traffic flow within the barangay.',
    icon: Car,
    estimatedTime: '3-5 business days',
    difficulty: 'Medium',
    steps: [
      {
        ...
        description: "Prepare detailed plans for your event or activity that affects traffic.",
        requirements: [
      ...
      },
      {
        ...
        description: "Meet with barangay officials to discuss your plans and requirements.",
        notes: "Barangay may require additional safety measures or adjustments."
      },
      {
        id: 3,
        title: "Submit Application",
        description: "Submit formal application for traffic clearance with all supporting documents.",
        requirements: [
          "Application letter",
          "Event plan and map",
          "Traffic management plan",
      ...
      },
      {
        id: 5,
        title: "Site Inspection",
        description: "Allow barangay and traffic officials to inspect the event site.",
        notes: "They will verify your traffic management preparations."
      },
      {
        id: 6,
        title: "Receive Clearance",
        description: "Receive your traffic clearance and comply with all conditions.",
