...
import { Package, Plus, Edit, Trash2, AlertTriangle, Box, Search, X, TrendingUp, TrendingDown } from 'lucide-react';
...
const Inventory: React.FC = () => {
  ...
  const [products, setProducts] = useState<Item[]>([
    { id: '680212ebec8f3c32f1aeff0f', name: 'Eco Rug', image: '/build/assets/package-CSC_z-ZA.js' },
    { id: '6802139aec8f3c32f1aeff1e', name: 'Eco Bag', image: '/build/assets/package-CSC_z-ZA.js' },
    { id: '68021467ec8f3c32f1aeff24', name: 'Liquid Fertilizer', image: '/build/assets/package-CSC_z-ZA.js' },
  ]);

  const [materials, setMaterials] = useState<Item[]>([
    { id: '6803639330d494ae93ac5e3f', name: 'PET bottles', image: '/build/assets/pen-CEWIcInK.js' },
    { id: '680363d830d494ae93ac5e45', name: 'Soft and hard plastics', image: '/build/assets/pen-CEWIcInK.js' },
  ]);
  ...
  function addItem(type: 'product' | 'material') {
    ...
    const newItem: Item = { id: Date.now().toString(16), name: formName.trim(), image: formImage || '' };
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm animate-in fade-in duration-300">
        ...
        <div
          ...
          className="relative bg-white rounded-3xl shadow-2xl max-w-4xl w-full mx-4 z-10 animate-in zoom-in-95 slide-in-from-bottom-4 duration-300 overflow-hidden"
        >
          ...
          <div className="px-8 pt-8 pb-6 border-b border-gray-100 bg-gradient-to-br from-gray-50 to-white">
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="p-4 bg-gradient-to-br from-green-100 via-green-50 to-emerald-100 rounded-2xl shadow-lg shadow-green-500/20 ring-1 ring-green-200/50">
                  {type === 'product' ? (
                    <Package className="w-7 h-7 text-green-700" />
                  ) : (
                    <Box className="w-7 h-7 text-green-700" />
                  )}
                </div>
                <div>
                  <h3 id="add-modal-title" className="text-2xl font-bold text-gray-900 tracking-tight">
                    Add New {type === 'product' ? 'Product' : 'Material'}
                  </h3>
                  <p className="text-sm text-gray-500 mt-1.5">Fill in the details below to create a new entry</p>
                </div>
              </div>
              <button 
                aria-label="Close" 
                onClick={onClose} 
                className="text-gray-400 hover:text-gray-700 hover:bg-gray-100 p-3 rounded-2xl transition-all duration-200 hover:rotate-90"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
          ...
          <div className="px-8 py-8">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              <div className="lg:col-span-3 space-y-6">
                ...
                <div className="group">
                  ...
                  <Input 
                    ...
                    className="border-2 border-gray-200 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 rounded-xl h-12 text-base transition-all duration-200 group-hover:border-gray-300"
                  />
                  <p className="text-xs text-gray-400 mt-2 ml-1">Or upload an image file below</p>
                </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="relative w-full h-80 rounded-2xl overflow-hidden border-2 border-dashed border-gray-300 bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center p-6 group hover:border-green-400 transition-all duration-300">
                  {formImage ? (
                    <div className="relative w-full h-full">
                      ...
                      />
                      <div className="absolute top-3 right-3 bg-green-600 text-white text-xs font-bold px-3 py-1.5 rounded-lg shadow-lg">
                        ✓ Ready
                      </div>
                    </div>
                  ) : (
                    <div className="text-center">
                      <div className="w-20 h-20 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      ...
                      <p className="text-xs text-gray-400">Upload a file or paste a URL</p>
          ...
          <div className="px-8 py-6 bg-gradient-to-r from-gray-50 to-gray-100/50 border-t border-gray-200 rounded-b-3xl flex items-center justify-between">
            <p className="text-xs text-gray-500 font-medium flex items-center gap-1.5">
              <span className="text-red-500 text-sm">*</span> Required field
            </p>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative group">
          ...
          <Input 
            ...
            className="pl-12 pr-4 py-3 w-96 border-2 border-gray-200 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 text-base bg-white"
          />
          {search && (
            <button
              onClick={() => setSearch('')}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group cursor-pointer">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="p-4 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 group-hover:scale-110 transition-transform duration-300">
              ...
              <TrendingUp className="w-5 h-5 text-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </div>
          </CardContent>
        </Card>
                  ...
                  <div key={p.id} className="flex items-center justify-between p-5 hover:bg-gradient-to-r hover:from-green-50/50 hover:to-transparent transition-all duration-200 group">
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-400 font-mono mt-1 bg-gray-100 px-2 py-1 rounded inline-block">{p.id}</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="text-sm font-bold text-green-700 bg-green-50 px-4 py-2 rounded-lg">1 Point</div>
                      <Button variant="outline" className="px-4 py-2 rounded-lg hover:bg-blue-50 hover:border-blue-300 hover:text-blue-700 transition-all duration-200">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Button 
            ...
            className="bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white inline-flex items-center gap-2 px-6 py-3 rounded-xl shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-600/40 transition-all duration-200 font-bold hover:scale-[1.02] active:scale-[0.98]"
          >
            <Plus className="w-5 h-5"/> 
            Add Material
          </Button>
            ...
            <div className="divide-y divide-gray-100">
              {filteredMaterials.length === 0 ? (
                ...
                filteredMaterials.map((m, idx) => (
                  <div key={m.id} className="flex items-center justify-between p-5 hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-transparent transition-all duration-200 group">
                    <div className="flex items-center gap-5">
                      <div className="relative">
                        <div className="w-16 h-16 rounded-2xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 shadow-md group-hover:shadow-lg transition-shadow duration-200 ring-2 ring-white">
                      ...
                      <div>
                        <div className="font-bold text-gray-900 text-lg group-hover:text-blue-700 transition-colors duration-200">{m.name}</div>
                        <div className="text-xs text-gray-400 font-mono mt-1 bg-gray-100 px-2 py-1 rounded inline-block">{m.id}</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="text-sm font-bold text-blue-700 bg-blue-50 px-4 py-2 rounded-lg">1 Unit</div>
                      <Button variant="outline" className="px-4 py-2 rounded-lg hover:bg-blue-50 hover:border-blue-300 hover:text-blue-700 transition-all duration-200">
                        <Edit className="w-4 h-4"/>
                      </Button>
                      <Button variant="destructive" className="px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-200">
