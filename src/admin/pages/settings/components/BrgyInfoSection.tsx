      ...
      <CardContent className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
            ...
            {editingBarangay ? (
              <>
                <input
                  ...
                  className="flex-1 px-3 py-2 text-sm sm:text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all shadow-sm"
              ...
              <>
                <div className="flex-1 px-3 py-2 text-sm sm:text-lg bg-gray-50 border border-gray-200 rounded-lg font-semibold text-gray-900">
                  {barangayName || 'Not set'}
                </div>
                <button
                  onClick={() => setEditingBarangay(true)}
                  className="sm:flex-shrink-0 px-3 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-600 to-green-700 text-white font-semibold rounded-lg hover:from-green-700 hover:to-green-800 transition-all shadow-sm flex items-center justify-center gap-2 text-sm sm:text-base"
                >
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-4 sm:gap-6">
            <div className="w-32 h-32 sm:w-48 sm:h-48 bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-dashed border-gray-300 rounded-2xl flex items-center justify-center overflow-hidden flex-shrink-0 hover:border-green-400 transition-all mx-auto lg:mx-0 shadow-inner">
              {logoPreview ? (
                <img
                  src={logoPreview}
                  alt="Barangay logo"
                ...
                <div className="text-center">
                  <Building className="w-12 h-12 sm:w-16 sm:h-16 text-gray-400 mx-auto mb-2" />
            ...
            <div className="flex flex-col gap-4 flex-1 w-full">
              ...
              <label
                htmlFor="logo-upload"
                className={`inline-flex items-center justify-center gap-2 sm:gap-3 px-3 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-600 to-green-700 text-white font-semibold rounded-lg cursor-pointer hover:from-green-700 hover:to-green-800 transition-all shadow-sm w-full lg:w-auto ${
