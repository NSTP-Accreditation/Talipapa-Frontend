...
const EditModal: React.FC<EditModalProps> = ({ form, isOpen, onClose, onSave }) => {
    ...
    >
      <div className="forms-modal-content">
        ...
        <div className="forms-modal-header">
          ...
          <button
            onClick={onClose}
            className="forms-modal-close-btn"
          >
            ✕
          </button>
        </div>
        ...
        <div className="forms-modal-body">
          <div className="forms-form-container">
            ...
            <div className="forms-form-group">
              <label className="forms-form-label">
                PDF File {!form?.id ? '*' : '(Optional - leave blank to keep current file)'}
              </label>
              <div className="forms-file-upload">
                ...
                <label htmlFor="pdf-upload" className="forms-file-label">
                  <svg className="forms-file-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                  </svg>
                  {selectedFile ? selectedFile.name : 'Choose PDF file or drag and drop'}
                </label>
              </div>
              
              {formData.fileName && (
                <div className="forms-file-info">
                  <span className="forms-file-name">📄 {formData.fileName}</span>
...
const DeleteModal: React.FC<DeleteModalProps> = ({ form, isOpen, onClose, onConfirm }) => {
      ...
      <div className="forms-delete-modal">
        ...
        <div className="forms-delete-header">
          <div className="forms-delete-header-content">
            <div className="forms-delete-icon">
              <svg className="forms-delete-icon-svg" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
              </svg>
            </div>
            <div>
              <h2 className="forms-delete-title">
                Delete Form
              </h2>
        ...
        <div className="forms-delete-body">
          <p className="forms-delete-message">
            Are you sure you want to delete the form <strong>"{form.title}"</strong>?
          </p>
          
          <div className="forms-delete-details">
            <h4 className="forms-delete-details-title">
              Form Details:
            </h4>
          ...
          <div className="forms-delete-warning">
            <div className="forms-delete-warning-content">
              <svg className="forms-delete-warning-icon" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
              </svg>
              <p className="forms-delete-warning-text">
                Warning: This will permanently remove this form and its associated PDF file from the system.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="forms-modal-footer">
          ...
          <button
            onClick={onConfirm}
            className="forms-btn forms-btn-danger"
          >
            Delete Form
          </button>
        </div>
...
const Forms: React.FC = () => {
  const [forms, setForms] = useState<FormDocument[]>([
    {
      ...
      description: 'Official form for requesting barangay clearance certificate',
      category: 'Clearances',
    ...
    },
    {
      ...
      description: 'Application form for indigency certificate for low-income residents',
  ...
  const handleBulkDelete = () => {
    ...
    if (confirm(`Are you sure you want to delete ${count} form${count > 1 ? 's' : ''}?\n\n${formTitles}`)) {
  ...
  const categories = ['Clearances', 'Permits', 'Certificates', 'Applications', 'Reports', 'Others'];
    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredForms.map((form) => (
          <Card key={form.id} className="bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
      ...
      {filteredForms.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="mt-1 text-sm text-gray-500">
            {searchTerm || filterCategory ? 'Try adjusting your search or filter criteria.' : 'Get started by creating your first form.'}
          </p>
