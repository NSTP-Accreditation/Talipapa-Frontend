import { CheckCircle, Eye, Target, Leaf, Heart, Award, ShieldCheck } from "lucide-react";
    ...
    <section className="bg-green-50 py-12 px-6 flex flex-col items-center">
      ...
      <header className="max-w-2xl text-center mb-12">
        ...
        <p className="mt-3 text-gray-600 text-base leading-relaxed">
          Guided by our commitment to sustainable development and community welfare, 
          we strive to build a better future for all residents of Barangay Talipapa.
        </p>
      </header>
...
<div className="border border-green-200 shadow-md rounded-lg bg-white p-8 flex flex-col items-center max-w-sm mx-auto">
  <Target className="text-green-600 mb-6" size={40} /> {/* increased spacing */}
  <h3 className="text-base font-semibold mb-4 text-center pb-[5px]">Our Mission</h3>
  <p className="text-gray-1000 text-sm mb-4 leading-relaxed text-justify">
    To provide efficient, transparent, and sustainable governance that promotes 
    the welfare of all residents while preserving our environment for future generations.
  </p>
</div>

{/* Vision */}
<div className="border border-green-200 shadow-md rounded-lg bg-white p-8 flex flex-col items-center max-w-sm mx-auto">
  <Eye className="text-green-600 mb-6" size={40} /> {/* increased spacing */}
  <h3 className="text-base font-semibold mb-4 text-center  pb-[5px]">Our Vision</h3>
  <p className="text-gray-600 text-sm mb-4 leading-relaxed text-justify">
    To be a model eco-friendly barangay that exemplifies sustainable living, 
    where every resident enjoys a high quality of life in harmony with nature.
  </p>
</div>
...
<div className="max-w-5xl w-[1200px] mt-[50px] mx-auto">
  <div className="bg-green-600 rounded-xl py-16 px-10 grid grid-cols-4 gap-10 text-center text-white">
    <div className="flex flex-col items-center justify-center">
      ...
      <p className="text-sm opacity-90 mt-1">Protecting our environment</p>
    </div>
    <div className="flex flex-col items-center justify-center">
    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <p className="text-sm opacity-90 mt-1">Quality services with integrity</p>
    </div>
    <div className="flex flex-col items-center justify-center">
