      ...
      <main className="max-w-7xl mx-auto py-16 px-6">
        ...
        <div className="text-center">
          <Link to="/guidelines/more">
            <Button className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded">More Guides</Button>
          </Link>
        </div>
      </main>
      ...
      <footer className="bg-gray-900 text-white py-12 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">A green and sustainable community where nature and people thrive together.</p>
